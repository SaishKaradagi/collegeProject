...
export default function AboutCard() {
  return (
    <>
      <AnimatedElement>
        <h1 className="m-2 text-3xl font-extrabold text-gray-900 dark:text-white md:text-4xl lg:text-5xl">
          ...
          <div className="mx-auto flex py-6 md:px-5 md:flex-row justify-center flex-col items-center">
            ...
            <div className="md:w-1/2  md:pl-8 flex flex-col md:items-start md:text-left items-center">
              ...
              <p className="mb-8 leading-relaxed font-medium text-sm sm:text-lg p-2">
                Established in 2008, SG Balekundri Institute of Technology is
                one of the most acclaimed self-financed engineering colleges in
                Karnataka. It has been established by Shri Sidddharameshwar
                Education Trust (SSET),{" "}
                <span className="font-bold">
                  {" "}
                  a trust known for its deep sense of social commitment and
        ...
        <section className="text-gray-600 body-font ">
          <div className="mx-auto flex py-10 md:px-5 md:flex-row-reverse justify-center flex-col items-center">
            ...
            <div className="md:w-1/2 md:pr-8 flex flex-col md:items-start md:text-left items-center">
              ...
              <p className="mb-8 leading-relaxed font-medium text-sm sm:text-lg p-2">
                In a metamorphosis of over 16 years, SG Balekundri Institute of
                Technology has been reinventing itself constantly to explore the
                infinite possibilities of engineering and technology – an
                academy that inspires everyone to think differently. It is now
                the preferred career destination for meritorious students due to
                its academic integrity and standard as well as its attractive
                campus placement.
              </p>
            </div>
          </div>
