    ...
    <>
      <div className="sticky bg-white bg-opacity-40 top-0 z-50 backdrop-blur-2xl transform transition-all duration-1000 ease-in-out">
        ...
        <nav className="bg-transparent flex justify-evenly items-center">
          <div
            className={`items-center justify-center ${NavOpen ? "h-96 p-2" : "h-0"} transition-transition-height duration-500 ease-in-out overflow-hidden md:overflow-visible md:h-full md:p-2 w-full md:flex bg-blue-950 md:order-1`}
          >
            {/* Mobile Search */}
