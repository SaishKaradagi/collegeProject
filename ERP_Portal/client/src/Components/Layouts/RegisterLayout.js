...
const RegisterLayout = () => {
  ...
  return (
    ...
    >
      <CircleDesign />
      <section className="my-8 flex h-fit w-fit animate-fadeInFast flex-col justify-start gap-6 rounded-md bg-slate-100 p-4 text-slate-900 opacity-70 duration-200 hover:opacity-100 focus:opacity-100 dark:bg-[#060913] dark:text-slate-50 md:p-8 lg:flex-row xl:w-1/2 ">
          ...
          <div className="m-2 flex flex-col-reverse gap-4 text-4xl md:text-5xl  lg:flex-col ">
            ...
            >
              ...
              <img
                src="/favicon.ico"
                alt="College Icon"
                className="inline-block h-5 w-5 rounded-full md:h-5 md:w-5 xl:h-5 xl:w-5"
              />
