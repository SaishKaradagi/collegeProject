        ...
        <main className="relative z-0 flex h-screen flex-col items-center justify-center bg-gradient-to-b from-slate-400 to-slate-300 text-slate-950 dark:from-slate-800 dark:to-slate-950 dark:text-slate-300">
          ...
          <section className="z-0 mb-4 flex items-center gap-2 whitespace-nowrap text-6xl duration-200 md:text-8xl lg:gap-4">
            ...
            <img
              src="/favicon.ico"
              alt="College Icon"
              className="inline-block h-16 w-16 rounded-full md:h-20 md:w-20 xl:h-24 xl:w-24"
            />
            <h1 className="font-spectral font-semibold  text-slate-900  dark:text-slate-300 ">
              SGBIT
            </h1>
          </section>
          <section className="z-0 w-[65%] justify-self-center rounded-lg bg-slate-100 opacity-80 duration-200 hover:opacity-100 focus:opacity-100 dark:bg-[#060913] sm:w-[min(50%,360px)] md:w-[min(40%,360px)] xl:w-[min(23%,360px)] ">
            <form
